...
$newContent = <<<'EOD'
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    @forelse ($actualites as $actu)
                        ...
                        @endphp
                        <article class="bg-[#FAF7F2] rounded-none overflow-hidden border border-[#D4A373]/30 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
                            <div>
                                <div class="relative h-48 overflow-hidden bg-slate-900 cursor-pointer"
                                    ...
                                    <img alt="{{ $actu->titre }}"
                                        ...
                                        src="{{ $imgPath }}" />
                                    <span class="absolute top-3 left-3 bg-[#1E1613]/80 text-[#D4A373] text-[10px] font-bold px-2.5 py-0.5 rounded-none backdrop-blur-sm uppercase">
                                        Actualité
                                    </span>
                                </div>
                            ...
                            <div class="p-6 pt-0 border-t border-[#D4A373]/10 mt-2 flex items-center justify-between text-xs text-[#C85A32] font-bold">
                                ...
                                <a href="{{ route('public.actualites') }}" class="flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                                    Lire la suite
                                    <svg aria-hidden="true" class="lucide lucide-arrow-right w-3.5 h-3.5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                                </a>
                            </div>
                        </article>
                    @empty
...
array_splice($lines, $start, $end - $start + 1, $newContent . "\n");
