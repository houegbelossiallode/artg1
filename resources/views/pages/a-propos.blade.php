...
<div class="inline-flex items-center gap-2 px-3.5 py-1 rounded-none bg-[#F4EFE6] border border-[#D4A373]/30 text-[#C85A32] text-xs font-bold uppercase tracking-widest">
...
<div class="space-y-6">
<h3 class="font-serif-title text-2xl sm:text-3xl font-bold text-[#2C221E] border-l-4 border-[#C85A32] pl-4">
...
<svg aria-hidden="true" class="lucide lucide-circle-check w-5 h-5 text-[#C85A32] shrink-0 mt-0.5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<span class="text-xs uppercase font-bold text-[#D4A373] bg-[#1E1613]/80 px-2.5 py-1 rounded-none">
        Atelier Vivant
       </span>
...
<div class="absolute -bottom-6 -left-6 bg-[#1E1613] text-[#FAF7F2] p-5 rounded-none shadow-xl border border-[#D4A373]/40 max-w-xs hidden sm:block">
<div class="flex items-center gap-3">
<div class="w-10 h-10 rounded-none bg-[#C85A32] flex items-center justify-center text-white shrink-0">
...
<div class="glass-panel rounded-none p-6 text-center space-y-2 hover:border-[#C85A32]/40 transition-all transform hover:-translate-y-1 shadow-sm">
...
<div class="bg-white rounded-none p-4 border border-[#D4A373]/20 text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
<img alt="Maître Sekou Kouyaté" class="w-20 h-20 rounded-none mx-auto object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&amp;fit=crop&amp;q=80&amp;w=300"/>
<div>
<h4 class="font-bold text-sm text-[#2C221E]">
        Maître Sekou Kouyaté
       </h4>
<p class="text-xs text-[#C85A32] font-medium">
        Directeur Musical &amp; Conservateur
       </p>
</div>
</div>
<div class="bg-white rounded-none p-4 border border-[#D4A373]/20 text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
<img alt="Maman Rose Edjang" class="w-20 h-20 rounded-none mx-auto object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&amp;fit=crop&amp;q=80&amp;w=300"/>
<div>
<h4 class="font-bold text-sm text-[#2C221E]">
        Maman Rose Edjang
       </h4>
...
<div class="bg-white rounded-none p-4 border border-[#D4A373]/20 text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
<img alt="Aline Mercier" class="w-20 h-20 rounded-none mx-auto object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&amp;fit=crop&amp;q=80&amp;w=300"/>
<div>
<h4 class="font-bold text-sm text-[#2C221E]">
        Aline Mercier
       </h4>
...
<div class="bg-white rounded-none p-4 border border-[#D4A373]/20 text-center space-y-3 shadow-sm hover:shadow-md transition-shadow">
<img alt="Dr. Joseph Nguema" class="w-20 h-20 rounded-none mx-auto object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&amp;fit=crop&amp;q=80&amp;w=300"/>
<div>
<h4 class="font-bold text-sm text-[#2C221E]">
        Dr. Joseph Nguema
       </h4>
