...
<div class="lg:col-span-7 bg-white rounded-none p-8 sm:p-10 border border-[#D4A373]/30 shadow-xl space-y-6">
...
<form id="contactForm" class="space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <input name="nom" class="w-full px-4 py-2.5 rounded-none bg-[#FAF7F2] border border-[#D4A373]/30 text-xs focus:outline-none focus:border-[#C85A32]" placeholder="e.g. Marie Nguema" required type="text" value="{{ old('nom') }}"/>
        </div>
        <div>
            <label class="block text-xs font-bold text-[#2C221E] uppercase mb-1">
                Adresse e-mail *
            </label>
            <input name="email" class="w-full px-4 py-2.5 rounded-none bg-[#FAF7F2] border border-[#D4A373]/30 text-xs focus:outline-none focus:border-[#C85A32]" placeholder="e.g. marie@exemple.com" required type="email" value="{{ old('email') }}"/>
        </div>
    </div>
    <div>
        <label class="block text-xs font-bold text-[#2C221E] uppercase mb-1">
        ...
        <select name="objet" class="w-full px-4 py-2.5 rounded-none bg-[#FAF7F2] border border-[#D4A373]/30 text-xs focus:outline-none focus:border-[#C85A32]" required>
    ...
    <div>
        ...
        <textarea name="message" class="w-full px-4 py-2.5 rounded-none bg-[#FAF7F2] border border-[#D4A373]/30 text-xs focus:outline-none focus:border-[#C85A32]" placeholder="Précisez votre demande, vos disponibilités ou vos questions..." required rows="4">{{ old('message') }}</textarea>
    </div>
    <button type="submit" class="w-full py-3.5 rounded-none bg-[#C85A32] hover:bg-[#A84223] text-white font-bold text-xs shadow-md transition-all flex items-center justify-center gap-2">
...
<div class="bg-[#1E1613] text-[#FAF7F2] rounded-none p-8 border border-[#D4A373]/30 space-y-6 shadow-xl">
<h3 class="font-serif-title text-2xl font-bold text-white">
       Maison de l’Association Culturelle
      </h3>
<div class="space-y-4 text-xs font-sans">
<div class="flex items-start gap-3">
<svg aria-hidden="true" class="lucide lucide-map-pin w-5 h-5 text-[#D4A373] shrink-0 mt-0.5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div class="flex items-start gap-3">
<svg aria-hidden="true" class="lucide lucide-phone-call w-5 h-5 text-[#D4A373] shrink-0 mt-0.5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div class="flex items-start gap-3">
<svg aria-hidden="true" class="lucide lucide-mail w-5 h-5 text-[#D4A373] shrink-0 mt-0.5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7">
</path>
<rect height="16" rx="2" width="20" x="2" y="4">
</rect>
...
<svg aria-hidden="true" class="lucide lucide-clock w-5 h-5 text-[#D4A373] shrink-0 mt-0.5" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<path d="M12 6v6l4 2">
</path>
...
<button class="w-full p-5 text-left flex items-center justify-between font-bold text-sm text-[#2C221E] hover:text-[#C85A32] transition-colors">
<span class="flex items-center gap-2">
<svg aria-hidden="true" class="lucide lucide-circle-question-mark w-4 h-4 text-[#C85A32]" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
<circle cx="12" cy="12" r="10">
</circle>
...
<div class="p-5 pt-0 text-xs text-[#6B574F] font-sans leading-relaxed border-t border-[#D4A373]/10 animate-in fade-in duration-200">
