...
<div class="bg-[#1E1613] rounded-none overflow-hidden shadow-2xl border border-[#D4A373]/40 grid grid-cols-1 lg:grid-cols-12 text-[#FAF7F2]">
...
<svg aria-hidden="true" class="lucide lucide-disc w-5 h-5 text-[#D4A373]" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<button aria-label="Play sample" class="w-10 h-10 rounded-none bg-[#C85A32] hover:bg-[#A84223] text-white flex items-center justify-center shadow-lg transition-transform hover:scale-105">
...
<div class="space-y-4">
<div class="flex items-center justify-between">
<span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-none bg-[#C85A32]/20 border border-[#C85A32]/40 text-[#D4A373] text-xs font-bold uppercase">
...
<svg aria-hidden="true" class="lucide lucide-award w-3.5 h-3.5 text-[#C85A32] shrink-0" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<button onclick="document.getElementById('candidature-modal').classList.remove('hidden')" class="px-5 py-2.5 rounded-none bg-[#C85A32] hover:bg-[#A84223] text-white font-bold text-xs shadow-lg transition-transform hover:scale-105 flex items-center gap-2">
...
<div class="cursor-pointer bg-white rounded-none p-5 border transition-all duration-300 space-y-4 hover:shadow-xl border-[#C85A32] ring-2 ring-[#C85A32]/20 shadow-md">
<div class="flex items-center gap-4">
<img alt="Samuel Nguema" class="w-16 h-16 rounded-none object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="/assets/young_musician_talent_1785764994375-Cmnv-yWc.jpg"/>
<div>
...
<div class="pt-2 border-t border-[#D4A373]/20 flex items-center justify-between text-xs text-[#C85A32] font-bold">
...
<div class="cursor-pointer bg-white rounded-none p-5 border transition-all duration-300 space-y-4 hover:shadow-xl border-[#D4A373]/30 hover:border-[#D4A373]">
<div class="flex items-center gap-4">
<img alt="Inès Biyogo" class="w-16 h-16 rounded-none object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&amp;fit=crop&amp;q=80&amp;w=400"/>
<div>
<h4 class="font-bold text-base text-[#2C221E]">
         Inès Biyogo
        </h4>
...
<div class="cursor-pointer bg-white rounded-none p-5 border transition-all duration-300 space-y-4 hover:shadow-xl border-[#D4A373]/30 hover:border-[#D4A373]">
<div class="flex items-center gap-4">
<img alt="Lionel Kassa" class="w-16 h-16 rounded-none object-cover ring-2 ring-[#D4A373]/40" referrerpolicy="no-referrer" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&amp;fit=crop&amp;q=80&amp;w=400"/>
<div>
<h4 class="font-bold text-base text-[#2C221E]">
         Lionel Kassa
        </h4>
...
<div class="p-8 rounded-none bg-gradient-to-r from-[#F4EFE6] to-[#FAF7F2] border border-[#D4A373]/40 flex flex-col sm:flex-row items-center justify-between gap-6">
...
<button onclick="document.getElementById('candidature-modal').classList.remove('hidden')" class="px-6 py-3 rounded-none bg-[#2C221E] hover:bg-[#C85A32] text-white font-bold text-xs whitespace-nowrap transition-colors flex items-center gap-2 shadow">
