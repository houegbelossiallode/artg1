...
<svg aria-hidden="true" class="lucide lucide-heart w-3.5 h-3.5 fill-current text-[#0BA20B]" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
<div class="flex justify-center max-w-md mx-auto bg-[#F4EFE6] p-1.5 rounded-none border border-[#0BA20B]/30">
<button class="flex-1 py-2.5 rounded-none text-xs font-bold transition-all bg-[#0BA20B] text-white shadow">
     Faire un Don Ponctuel ou Mensuel
    </button>
<button class="flex-1 py-2.5 rounded-none text-xs font-bold transition-all text-[#2C221E] hover:text-[#0BA20B]">
...
<div class="bg-[#1E1613] text-[#FAF7F2] rounded-none p-8 sm:p-12 shadow-2xl border border-[#0BA20B]/30 max-w-4xl mx-auto space-y-8">
<div class="text-center space-y-2">
<span class="text-xs uppercase font-bold text-[#0BA20B]">
...
<div class="glass-dark rounded-none p-6 border border-[#0BA20B]/30 space-y-3 text-center max-w-2xl mx-auto">
<div class="flex items-center justify-center gap-2 text-[#0BA20B] text-xs font-bold uppercase">
...
<span>
       ...
       <strong class="text-[#0BA20B] font-bold">
