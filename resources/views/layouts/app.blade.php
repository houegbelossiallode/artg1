        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between flex-nowrap gap-4">
            ...
            <nav class="hidden lg:flex items-center gap-1 xl:gap-2 flex-nowrap shrink-0">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute left-0 top-full hidden group-hover:block w-64 bg-[#1E1613] border border-[#D4A373]/30 shadow-2xl py-2 z-50">
                        <a href="{{ url('/#events') }}" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-semibold text-white/90 hover:text-[#D4A373] hover:bg-white/5 transition-colors uppercase tracking-wider">
                            <span class="w-1.5 h-1.5 bg-[#C85A32]"></span>
                            Événements
                        </a>
                        <a href="{{ url('/#courses') }}" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-semibold text-white/90 hover:text-[#D4A373] hover:bg-white/5 transition-colors uppercase tracking-wider">
                            <span class="w-1.5 h-1.5 bg-[#D4A373]"></span>
                            Formations (Cours &amp; Formations)
                        </a>
                        <a href="{{ url('/#gallery') }}" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-semibold text-white/90 hover:text-[#D4A373] hover:bg-white/5 transition-colors uppercase tracking-wider">
                            <span class="w-1.5 h-1.5 bg-[#C85A32]"></span>
                            Galerie
                        </a>
                        <a href="{{ url('/#news') }}" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-semibold text-white/90 hover:text-[#D4A373] hover:bg-white/5 transition-colors uppercase tracking-wider">
                            <span class="w-1.5 h-1.5 bg-[#D4A373]"></span>
                            Actualités
                        </a>
                    </div>
    ...
    <footer class="bg-[#1E1613] text-[#FAF7F2] pt-16 pb-12 border-t border-[#D4A373]/20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    <h4 class="font-serif-title font-bold text-sm text-[#D4A373] uppercase tracking-wider mb-4">Newsletter</h4>
                    ...
                    <form id="newsletterForm" action="{{ route('newsletter.store') }}" method="POST" class="space-y-3">
                        @csrf
                        <input type="email" name="email" required placeholder="Votre email" class="w-full px-4 py-2.5 bg-white/5 border border-white/20 rounded-none text-white placeholder-white/50 text-xs focus:outline-none focus:border-[#D4A373] focus:ring-1 focus:ring-[#D4A373] transition-colors">
                        <button type="submit" class="w-full px-4 py-2.5 bg-[#C85A32] hover:bg-[#A84223] text-white font-bold text-xs rounded-none transition-colors shadow-lg">
                            S'inscrire
                        </button>
                    </form>
                </div>
            ...
            <div class="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div>
                    <h4 class="font-serif-title font-bold text-sm text-[#D4A373] uppercase tracking-wider mb-2">Contact &amp; Mécénat</h4>
       ...
       <form action="{{ route('talent-candidatures.store') }}" method="POST" class="space-y-6">
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div class="space-y-2">
                   ...
                   <input required name="nom" type="text" placeholder="e.g. Samuel Nguema" class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
               </div>
               <div class="space-y-2">
                   <label class="block text-xs font-bold text-[#2C221E] uppercase tracking-wider">Prénom</label>
                   <input name="prenom" type="text" placeholder="e.g. Samuel" class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
               </div>
               <div class="space-y-2">
               ...
               <div class="space-y-2">
                   <label class="block text-xs font-bold text-[#2C221E] uppercase tracking-wider">Âge (15 – 25 ans) <span class="text-[#C85A32]">*</span></label>
                   <input required name="age" type="number" min="15" max="25" placeholder="21" class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
               </div>
               <div class="space-y-2">
                   <label class="block text-xs font-bold text-[#2C221E] uppercase tracking-wider">Discipline <span class="text-[#C85A32]">*</span></label>
                   <div class="relative">
                       <select required name="discipline_id" class="w-full appearance-none bg-white border border-[#D4A373]/40 p-3 pr-10 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors">
               ...
               <div class="space-y-2">
                   ...
                   <input required name="email" type="email" placeholder="e.g. samuel@exemple.com" class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
               </div>
               <div class="space-y-2">
                   <label class="block text-xs font-bold text-[#2C221E] uppercase tracking-wider">Téléphone</label>
                   <input name="telephone" type="text" placeholder="e.g. +241 06 12 34 56" class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
               </div>
               <div class="space-y-2">
                   <label class="block text-xs font-bold text-[#2C221E] uppercase tracking-wider">Numéro WhatsApp</label>
                   <input name="whatsapp" type="text" placeholder="e.g. +241 06 12 34 56" class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
               </div>
           </div>
           ...
           <div class="space-y-2">
               ...
               <input required name="demo_link" type="url" placeholder="https://youtube.com/watch?v=..." class="w-full bg-white border border-[#D4A373]/40 p-3 text-sm text-[#2C221E] focus:outline-none focus:border-[#C85A32] focus:ring-1 focus:ring-[#C85A32] rounded-none transition-colors placeholder-[#8C766B]/50" />
           </div>
