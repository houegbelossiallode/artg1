...
<section class="pt-28 pb-16 bg-[#FAF7F2] text-[#1E1613] min-h-screen">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <!-- Header -->
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#D4A373]/30 pb-6">
            <div>
                <div class="inline-flex items-center gap-2 px-3 py-1 bg-[#C85A32] text-white text-[10px] font-bold uppercase tracking-widest mb-2">
            ...
            <a href="{{ route('dashboard.apprenant') }}" class="px-4 py-2 bg-[#1E1613] text-white hover:bg-[#C85A32] text-xs font-bold uppercase tracking-wider transition-colors">
                &larr; Retour à l'espace apprenant
            </a>
        </div>

        <!-- Video Player Frame / Link -->
        <div class="bg-black border border-[#D4A373]/30 shadow-2xl overflow-hidden relative rounded-none aspect-video flex items-center justify-center">
            @if(Str::contains($reservation->lien_replay, ['youtube.com', 'youtu.be']))
                ...
                @else
                    <div class="p-8 text-center space-y-4">
                        ...
                        <a href="{{ $reservation->lien_replay }}" target="_blank" class="inline-block px-6 py-3 bg-[#C85A32] text-white font-bold text-xs uppercase tracking-widest">Ouvrir le Replay dans un nouvel onglet &rarr;</a>
                    </div>
                @endif
            ...
            @else
                <div class="p-8 text-center space-y-4">
                    <svg class="w-16 h-16 text-[#D4A373] mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <p class="text-white text-sm font-medium">L'enregistrement de ce cours est hébergé sur une plateforme partenaire.</p>
                    <a href="{{ $reservation->lien_replay }}" target="_blank" class="inline-block px-6 py-3 bg-[#C85A32] hover:bg-[#A84223] text-white font-bold text-xs uppercase tracking-widest transition-colors">
        ...
        <div class="bg-white border border-[#D4A373]/30 p-6 space-y-2">
