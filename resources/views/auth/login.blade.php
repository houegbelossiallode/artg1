...
<div class="min-h-screen pt-36 pb-20 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-pattern-raphia">
    <div class="max-w-4xl w-full bg-[#FAF7F2] border border-[#0BA20B]/30 shadow-2xl flex flex-col md:flex-row overflow-hidden relative z-10 rounded-none">
        ...
        <div class="md:w-1/2 bg-[#1E1613] text-[#FAF7F2] p-12 flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <span class="font-sans font-semibold text-xs tracking-widest uppercase text-[#0BA20B]">Espace Membre</span>
            ...
            <div class="mt-12 relative z-10">
                ...
                <div class="flex flex-wrap gap-2">
                    <span class="text-[10px] border border-[#0BA20B]/40 bg-white/5 py-1 px-3 font-medium rounded-none uppercase tracking-wider text-[#D1C5B8]">Musique</span>
                    <span class="text-[10px] border border-[#0BA20B]/40 bg-white/5 py-1 px-3 font-medium rounded-none uppercase tracking-wider text-[#D1C5B8]">Raphia</span>
                    <span class="text-[10px] border border-[#0BA20B]/40 bg-white/5 py-1 px-3 font-medium rounded-none uppercase tracking-wider text-[#D1C5B8]">Artisanat</span>
                </div>
            </div>
        </div>
        ...
        <div class="md:w-1/2 p-12 flex flex-col justify-center bg-[#FAF7F2]">
            ...
            <form action="{{ route('login.post') }}" method="POST" class="mt-8 space-y-5">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <a href="{{ route('password.request') }}" class="text-[10px] font-bold text-[#0BA20B] hover:text-[#087A08] transition-colors uppercase tracking-wider">Mot de passe oublié ?</a>
                        </div>
                ...
                <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox"
                        class="h-4 w-4 bg-white border-[#0BA20B]/40 text-[#0BA20B] rounded-none focus:ring-[#0BA20B]">
            ...
            <div class="mt-8 pt-6 border-t border-[#0BA20B]/20 text-center">
                <p class="text-xs text-[#6B574F] font-light">
                    ...
                    <a href="{{ route('register') }}" class="font-bold text-[#0BA20B] hover:text-[#087A08] transition-colors underline underline-offset-4">Créer un compte apprenant</a>
                </p>
            </div>
        </div>
