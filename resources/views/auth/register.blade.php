...
<div class="min-h-screen pt-32 pb-20 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-pattern-raphia">
    <div class="max-w-5xl w-full bg-[#FAF7F2] border border-[#0BA20B]/30 shadow-2xl flex flex-col md:flex-row overflow-hidden relative z-10 rounded-none">
        ...
        <div class="md:w-1/3 bg-[#1E1613] text-[#FAF7F2] p-10 flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="w-12 h-12 border border-[#0BA20B] flex items-center justify-center font-display font-bold text-[#0BA20B] text-xl tracking-wider mb-8">
                    É&C
                </div>
                <span class="font-sans font-semibold text-xs tracking-widest uppercase text-[#0BA20B]">Créer un compte</span>
                ...
                <div class="border-t border-white/10 pt-6">
                    ...
                    <ul class="text-xs font-light text-[#D1C5B8] space-y-3">
                        <li class="flex items-start gap-2">
                            <span class="text-[#0BA20B] mt-0.5">✓</span>
        ...
        <div class="md:w-2/3 p-8 sm:p-12 flex flex-col justify-center bg-[#FAF7F2]">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input id="nom" name="nom" type="text" required value="{{ old('nom') }}"
                            class="w-full px-4 py-3 bg-white border @error('nom') border-red-500 @else border-[#0BA20B]/40 @enderror text-[#2C221E] text-sm focus:outline-none focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] transition-all rounded-none placeholder-[#8C766B]/50"
                    ...
                    <div>
                        ...
                        <input id="prenom" name="prenom" type="text" required value="{{ old('prenom') }}"
                            class="w-full px-4 py-3 bg-white border @error('prenom') border-red-500 @else border-[#0BA20B]/40 @enderror text-[#2C221E] text-sm focus:outline-none focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] transition-all rounded-none placeholder-[#8C766B]/50"
                            placeholder="Prénoms">
                        @error('prenom')
                            <p class="text-[10px] text-red-600 mt-1 font-medium">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="sexe" name="sexe" required
                                class="w-full appearance-none px-4 py-3 bg-white border @error('sexe') border-red-500 @else border-[#0BA20B]/40 @enderror text-[#2C221E] text-sm focus:outline-none focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] transition-all rounded-none">
                    ...
                    <div>
                        ...
                        <input id="date_naissance" name="date_naissance" type="date" required value="{{ old('date_naissance') }}"
                            class="w-full px-4 py-3 bg-white border @error('date_naissance') border-red-500 @else border-[#0BA20B]/40 @enderror text-[#2C221E] text-sm focus:outline-none focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] transition-all rounded-none">
                    ...
                    <div>
                        ...
                        <input id="telephone" name="telephone" type="tel" required value="{{ old('telephone') }}"
                            class="w-full px-4 py-3 bg-white border @error('telephone') border-red-500 @else border-[#0BA20B]/40 @enderror text-[#2C221E] text-sm focus:outline-none focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] transition-all rounded-none placeholder-[#8C766B]/50"
                    ...
                    <div>
                        ...
                        <input id="adresse" name="adresse" type="text" required value="{{ old('adresse') }}"
                            class="w-full px-4 py-3 bg-white border @error('adresse') border-red-500 @else border-[#0BA20B]/40 @enderror text-[#2C221E] text-sm focus:outline-none focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] transition-all rounded-none placeholder-[#8C766B]/50"
            ...
            <div class="mt-8 pt-6 border-t border-[#0BA20B]/20 text-center">
                <p class="text-xs text-[#6B574F] font-light">
                    Vous possédez déjà un compte ? 
                    <a href="{{ route('login') }}" class="font-bold text-[#0BA20B] hover:text-[#087A08] transition-colors underline underline-offset-4 border-[#0BA20B]">Se connecter</a>
                </p>
            </div>
        </div>
