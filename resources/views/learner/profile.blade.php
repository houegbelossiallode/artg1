...
@section('title', 'Mon Profil | Espace Apprenant')
...
<div class="space-y-6">
  ...
  <div class="bg-white border border-slate-200 shadow-sm rounded-none relative overflow-hidden">
    ...
    <form action="{{ route('dashboard.apprenant.profile.update') }}" method="POST" enctype="multipart/form-data" class="relative z-10">
      @csrf
      @method('PUT')
      ...
      <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row items-start md:items-center gap-6">
        ...
        <div>
          ...
          <p class="text-xs text-slate-500 font-mono uppercase tracking-widest mt-1">Apprenant</p>
