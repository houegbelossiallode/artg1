...
<div class="space-y-6">
  ...
  <div class="bg-white border border-slate-200 shadow-sm px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      <h1 class="admin-title">Nouvel Événement</h1>
      <p class="admin-subtitle">Planifiez un nouvel événement dans l'agenda de l'association.</p>
    </div>
  ...
  <form action="{{ route('dashboard.admin.evenements.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white border border-slate-200 shadow-sm p-6 relative overflow-hidden">
          ...
          <div class="space-y-5">
            <div>
              ...
              <input type="text" name="titre" required class="w-full px-4 py-2.5 text-sm border border-slate-300 focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] focus:outline-none rounded-none bg-slate-50 transition-colors" placeholder="Ex: Festival des Arts Vivants" value="{{ old('titre') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input type="text" name="lieu" required class="w-full pl-9 pr-4 py-2.5 text-sm border border-slate-300 focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] focus:outline-none rounded-none bg-slate-50 transition-colors" placeholder="Adresse ou lieu exact" value="{{ old('lieu') }}">
                  </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div>
                ...
                <input type="date" name="date_debut" required class="w-full px-4 py-2.5 text-sm border border-slate-300 focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] focus:outline-none rounded-none bg-slate-50 transition-colors" value="{{ old('date_debut') }}">
              ...
              <div>
                ...
                <input type="date" name="date_fin" required class="w-full px-4 py-2.5 text-sm border border-slate-300 focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] focus:outline-none rounded-none bg-slate-50 transition-colors" value="{{ old('date_fin') }}">
              ...
              <div>
                ...
                <input type="time" name="heure" required class="w-full px-4 py-2.5 text-sm border border-slate-300 focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] focus:outline-none rounded-none bg-slate-50 transition-colors" value="{{ old('heure') }}">
    ...
    <div class="bg-white border border-slate-200 shadow-sm p-6 relative overflow-hidden mt-6">
      ...
      <textarea name="description" rows="6" class="w-full px-4 py-3 text-sm border border-slate-300 focus:border-[#0BA20B] focus:ring-1 focus:ring-[#0BA20B] focus:outline-none rounded-none bg-slate-50 transition-colors" placeholder="Détaillez le programme, les intervenants, etc...">{{ old('description') }}</textarea>
