...
<div class="space-y-6" x-data="{ activeGallery: null, currentImageIndex: 0, showTitle: '' }">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 pb-4 border-b border-slate-200">
    <div>
      <h1 class="admin-title">Événements & Représentations</h1>
      <p class="admin-subtitle">Gérez la programmation culturelle, les concerts et les ateliers.</p>
    </div>
    <div class="flex flex-wrap items-center gap-2">
      <a href="{{ route('dashboard.admin.evenements.create') }}" class="btn-primary">
  ...
  @else
    ...
    <div class="bg-white border border-slate-200 p-10 text-center space-y-3 max-w-md mx-auto my-8">
      ...
      <h3 class="text-sm font-bold text-slate-900 uppercase tracking-wider font-sans">Aucun événement</h3>
