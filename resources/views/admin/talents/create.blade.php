...
<div class="space-y-6">
  ...
  <div class="bg-white border border-slate-200 shadow-sm px-6 py-5 border-l-4 border-l-slate-900 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      <h1 class="text-lg font-bold text-slate-900 uppercase tracking-wide">CRÉER UN TALENT</h1>
      <p class="text-slate-400 text-sm mt-0.5">Enregistrez un nouveau jeune talent dans l'association.</p>
    </div>
