...
<div class="space-y-6">
  <div class="bg-white border border-slate-200 shadow-sm px-6 py-5 border-l-4 border-l-slate-900 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      <h1 class="text-lg font-bold text-slate-900 uppercase tracking-wide">NOUVELLE ACTUALITÉ</h1>
      <p class="text-slate-400 text-sm mt-0.5">Remplissez les informations ci-dessous pour publier une nouvelle actualité.</p>
    </div>
  ...
  <form action="{{ route('dashboard.admin.actualites.store') }}" method="POST" enctype="multipart/form-data" class="bg-white border border-slate-200 shadow-sm p-6 space-y-6">
    ...
    <div class="flex justify-end gap-3 pt-6 border-t border-slate-200">
      ...
      <button type="submit" class="px-6 py-2.5 text-xs uppercase font-bold tracking-wider bg-slate-900 hover:bg-slate-800 text-amber-500 transition-colors rounded-none shadow-md">Publier l'Actualité</button>
    </div>
  </form>
</div>
