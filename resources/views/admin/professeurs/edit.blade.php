...
<div class="space-y-6">
  ...
  <div class="bg-white border border-slate-200 shadow-sm px-6 py-5 border-l-4 border-l-lime-500 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
      ...
      <h1 class="text-lg font-bold text-slate-900 uppercase tracking-wide">MODIFIER UN PROFESSEUR</h1>
      <p class="text-slate-400 text-sm mt-0.5">Mettez à jour les informations du professeur. Un email de confirmation peut être envoyé.</p>
    </div>
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="nom" value="{{ old('nom', $professeur->nom) }}" required
                   class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition @error('nom') border-red-400 bg-red-50 @enderror"
          ...
          <div>
            ...
            <input type="text" name="prenom" value="{{ old('prenom', $professeur->prenom) }}" required
                   class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition @error('prenom') border-red-400 bg-red-50 @enderror"
                   placeholder="Prénom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <select name="sexe" required class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition @error('sexe') border-red-400 bg-red-50 @enderror">
          ...
          <div>
            ...
            <input type="date" name="date_naissance" value="{{ old('date_naissance', $professeur->date_naissance) }}" required
                   class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition @error('date_naissance') border-red-400 bg-red-50 @enderror">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input type="tel" name="telephone" value="{{ old('telephone', $professeur->telephone) }}" required
                   class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition @error('telephone') border-red-400 bg-red-50 @enderror"
          ...
          <div>
            ...
            <input type="text" name="adresse" value="{{ old('adresse', $professeur->adresse) }}" required
                   class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition @error('adresse') border-red-400 bg-red-50 @enderror"
      ...
      <div>
        ...
        <div>
          ...
          <textarea name="biographie" rows="4"
                    class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-lime-500 transition resize-none"
