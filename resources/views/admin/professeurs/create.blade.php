...
@section('title', 'Enregistrer un Professeur | AssoCulture')
...
<div class="space-y-6">
  ...
  <div class="bg-white border border-slate-200 shadow-sm">
    ...
    <form action="{{ route('dashboard.admin.professeurs.store') }}" method="POST" class="p-6 space-y-6">
      @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" name="prenom" value="{{ old('prenom') }}" required
              class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-amber-500 transition @error('prenom') border-red-400 bg-red-50 @enderror"
              placeholder="Prénom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <select name="sexe" required
              class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-amber-500 transition @error('sexe') border-red-400 bg-red-50 @enderror">
          ...
          <div>
            ...
            <input type="date" name="date_naissance" value="{{ old('date_naissance') }}" required
              class="w-full px-3 py-2 bg-slate-50 border border-slate-300 text-sm focus:outline-none focus:border-amber-500 transition @error('date_naissance') border-red-400 bg-red-50 @enderror">
      ...
      <div>
        ...
        <div>
          ...
          <textarea name="biographie" rows="4"
            ...
            placeholder="Présentation du professeur, domaine artistique, parcours pédagogique...">{{ old('biographie') }}</textarea>
        </div>
      </div>
