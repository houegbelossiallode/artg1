...
<div class="space-y-6" x-data="{ createModalOpen: false, editModalOpen: false, editMenu: {}, updateUrl: '' }">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 pb-4 border-b border-slate-200">
    <div>
      <h1 class="admin-title">Menus Principaux</h1>
      <p class="admin-subtitle">Gérez l'arborescence des menus rattachés aux modules système.</p>
    </div>
          ...
          @forelse ($menus as $menuItem)
            <tr class="hover:bg-slate-50 transition-colors">
              ...
              <td class="p-4 text-xs">
                @if($menuItem->icon)
                  <div class="flex items-center justify-center w-8 h-8 rounded-none bg-slate-100 text-slate-600 border border-slate-200 shadow-sm">
