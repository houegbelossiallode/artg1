...
<div class="space-y-6">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 pb-4 border-b border-slate-200">
    <div>
      ...
      <h1 class="admin-title">Nouvelle Fiche Association</h1>
      <p class="admin-subtitle">Enregistrez la présentation, la mission, la vision et les coordonnées du siège.</p>
    </div>
  ...
  <form action="{{ route('dashboard.admin.associations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 shadow-sm">
      <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
        ...
        <div>
          <h2 class="text-sm font-bold text-slate-900 uppercase tracking-wide font-sans">Identité de l'Association</h2>
      ...
      <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="file" name="logo" accept="image/*"
            class="w-full px-3 py-2 text-sm bg-slate-50 border border-slate-300 focus:outline-none focus:border-[#0BA20B] transition cursor-pointer
                   file:mr-4 file:py-1 file:px-3 file:border-0 file:text-xs file:font-bold file:uppercase file:bg-slate-200 file:text-slate-700 hover:file:bg-slate-300">
    ...
    <div class="bg-white border border-slate-200 shadow-sm">
      <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
        ...
        <div>
          <h2 class="text-sm font-bold text-slate-900 uppercase tracking-wide font-sans">Coordonnées & Siège</h2>
    ...
    <div class="bg-white border border-slate-200 shadow-sm">
      <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
        ...
        <div>
          <h2 class="text-sm font-bold text-slate-900 uppercase tracking-wide font-sans">Présence en Ligne</h2>
    ...
    <div class="bg-white border border-slate-200 shadow-sm">
      <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
        ...
        <div>
          <h2 class="text-sm font-bold text-slate-900 uppercase tracking-wide font-sans">Présentation Narrative</h2>
