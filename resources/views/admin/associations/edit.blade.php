...
<div class="space-y-6">
  ...
  <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 pb-4 border-b border-slate-200">
    <div>
      ...
      <h1 class="admin-title">MODIFIER — {{ strtoupper($association->nom) }}</h1>
      <p class="admin-subtitle">Mettez à jour les informations, la mission, la vision et les coordonnées du siège.</p>
    </div>
    ...
    <div class="bg-white border border-slate-200 shadow-sm">
      ...
      <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          @endif -->
          <label class="block text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-1.5">Logo de l'Association<span class="text-red-500">*</span></label>
